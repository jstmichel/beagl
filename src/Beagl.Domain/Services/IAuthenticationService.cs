...
public interface IAuthenticationService
{
    ...
    /// <param name="permanent">True to persist the login across browser sessions; otherwise, false.</param>
    /// <returns>A <see cref="AuthenticationResult"/> containing the result of the sign-in attempt.</returns>
    public Task<AuthenticationResult> SignInAsync(string email, string password, bool permanent);
}
