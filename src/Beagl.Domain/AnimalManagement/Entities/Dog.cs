...
public sealed class Dog(
    ...
    DateTimeOffset? modifiedAt = null) : Animal(name, SpeciesType.Dog, primaryBreedId, colorId, gender, birthDate, photo, microchip, createdByUserId, createdAt, modifiedByUserId, modifiedAt)
{
