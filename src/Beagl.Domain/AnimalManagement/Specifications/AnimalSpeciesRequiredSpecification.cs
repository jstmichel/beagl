...
/// <summary>
/// Ensures the animal species is not null or whitespace.
/// </summary>
public sealed class AnimalSpeciesRequiredSpecification : ISpecification<string>
{
    /// <summary>
    /// Determines whether the candidate satisfies the specification.
    /// </summary>
    /// <param name="candidate">The species to evaluate.</param>
