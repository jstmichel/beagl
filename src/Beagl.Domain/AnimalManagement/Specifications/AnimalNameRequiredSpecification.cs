...
/// <summary>
/// Ensures the animal name is not null or whitespace.
/// </summary>
public sealed class AnimalNameRequiredSpecification : ISpecification<string>
{
    /// <summary>
    /// Determines whether the candidate satisfies the specification.
    /// </summary>
    /// <param name="candidate">The name to evaluate.</param>
