...
namespace Beagl.Infrastructure.Migrations
{
    ...
    [Migration("20251106190443_AlterStreetFieldsInCitizen")]
    partial class AlterStreetFieldsInCitizen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Beagl.Domain.AnimalManagement.Entities.Animal", b =>
                {
                    ...
                    b.OwnsOne("Beagl.Domain.AnimalManagement.ValueObjects.Medal", "Medal", b1 =>
                        {
                            b1.Property<Guid>("AnimalId")
                                .HasColumnType("uuid");
